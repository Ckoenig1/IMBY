  ...
  return (
    <div className="App">
      ...
      <div className={"body-container"}>
        ...
        <div className="body-item instagram-carousel" style={{gridArea: "box-9"}}>
...
function SectionView({ section }) {
  ...
  const content = {
    ...
    beyond: { eyebrow: 'More than music', title: 'Beyond the Music', intro: 'A festival weekend built around local creativity, good food, and plenty of room to play.', body: <><h2>Artists</h2><p>We’re building a weekend that celebrates the artists, makers, and neighbors who make our backyard special.</p><h2>Food</h2><p>Come hungry. Local food vendors will keep the festival fueled throughout the weekend.</p><h2>Activities</h2><ul><li>Tie dye</li><li>Bracelet making</li><li>Collaborative mural</li><li>Yard games</li><li>Nature trails</li><li>Playground</li><li>Cyanotype workshop</li></ul></> },
    involved: { eyebrow: 'Join the community', title: 'Get Involved', intro: 'IMBY is only as successful as the community we have. We’d love to have you join that community.', body: <><h2>Volunteer at IMBY</h2><p>Volunteer with us! Please sign up here: <a href="https://www.signupgenius.com/go/20F0D4EA9AC29ABFEC34-65580751-imby#/" target="_blank" rel="noreferrer">IMBY volunteer signup</a>. All volunteers will receive a free shirt and early access information to next year’s festival.</p><p>Do you have any special skills or experience and interest in growing a music festival from the ground up? Reach out to us at <a href="mailto:contact@imbyfest.com">contact@imbyfest.com</a> or via social media and we’ll be in touch!</p><h2>About IWL</h2><p>IMBY is hosted on the grounds of the <a href="https://sites.google.com/view/iwla-loisgreensligochapter/home?pli=1&authuser=0" target="_blank" rel="noreferrer">Lois Green Chapter of the Izaak Walton League</a>, a local conservation group dedicated to preserving and enjoying the outdoors. The League helps make this festival possible through their stewardship of the land and their support of community-centered outdoor gathering.</p></> }
  }[section];
